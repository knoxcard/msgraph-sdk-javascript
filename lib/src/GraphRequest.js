    ...
    */
    ...
    GraphRequest.prototype.send = function (request, options, callback) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var self, middlewareControl, context_1, rawResponse, response, error_1, rawResponse, statusCode, gError;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        self = this, middlewareControl = new MiddlewareControl_1.MiddlewareControl(self._middlewareOptions);
                        self.updateRequestOptions(options);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, self.httpClient.sendRequest({
                                request: request,
                                options: options,
    ...
    GraphRequest.prototype.getRawResponse = function () {
        if (this.graphResponseHandler instanceof GraphResponseHandler_1.GraphResponseHandler) {
