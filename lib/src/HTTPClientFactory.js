...
var HTTPClientFactory = /** @class */ (function () {
    ...
    HTTPClientFactory.createWithAuthenticationProvider = function (authProvider) {
        var authenticationHandler = new AuthenticationHandler_1.AuthenticationHandler(authProvider), httpMessageHandler = new HTTPMessageHandler_1.HTTPMessageHandler();
